    ...
    dark:hover:bg-slate-800 transition-colors"
          ...
          <div className="hidden md:block">
            ...
            <p className=" text-slate-800 dark:text-white/80">
              Welcome back, Hassan Abd El Aziz
            </p>
          </div>
        </div>
        ...
        <div className="flex-1 max-w-md mx-8">
          <div className="relative">
            <Search
              className="w-4 h-4 absolute left-3 top-1/2 transform 
            ...
            py-2.5 bg-slate-100 dark:bg-slate-800 border
             border-slate-200 dark:border-slate-200 rounded-xl
        ...
        <div className="flex items-center space-x-3">
          {/* Quick Action */}
          <button
            className="hidden lg:flex items-center space-x-2 py-2
           px-4 bg-gradient-to-r from-blue-500 to-purple-600
          ...
          >
            ...
            <span
              className="absolute -top-5 w-5 h-5 bg-red-500 text-white text-xs 
